...
<body>
    <div class="add-user-container">
        ...
        <main class="main-content">
            <div class="form-panel">
                ...
                <form method="POST" action="/pos/public/users/create" id="add-user-form" onsubmit="return confirmSubmit()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" required aria-describedby="email-help" oninput="validateEmail()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="password" required aria-describedby="password-help" oninput="validatePassword()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password-confirm" name="password-confirm" required aria-describedby="password-confirm-help" oninput="validatePasswordConfirm()">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="role" name="role" required aria-describedby="role-help" onchange="updatePermissions()">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="address" name="address" aria-describedby="address-help"></textarea>
                    ...
                    <div class="permissions-group">
                        <div class="permissions-container">
                            <h3 class="form-title">Permissions Preview</h3>
                            <ul id="permissions-preview" class="permissions-preview">
    ...
    <script>
        ...
        function confirmSubmit() {
            if (confirm('Are you sure you want to add this user?')) {
                showAlert('success', 'User addition request sent.');
                return true;
            }
            return false;
        }
        ...
        // Update permissions preview based on role
        function updatePermissions() {
            ...
            const permissions = {
                cashier: ['View Sales', 'Process Transactions'],
                admin: ['Full Access', 'Manage Users', 'View Reports', 'Manage Stock'],
                inventory_clerk: ['Manage Stock', 'View Inventory']
            };

            const perms = permissions[role] || ['No permissions defined'];
            perms.forEach(perm => {
        ...
        // Initial call to populate permissions
    ...
    <style>
        ...
        .dark-theme .main-content, .dark-theme .add-user-container {
            background-color: #1f2937;
        }
        ...
        .dark-theme .permissions-container {
            background-color: #4b5563;
            border-color: #6b7280;
        }
        .dark-theme .permissions-preview {
            color: #d1d5db;
        }
